...
mod tests {
    use super::{
        ...
        metadata_sidecar_path, normalize_note_text, read_recording_metadata,
        rename_finalized_recording_if_named, slugify_library_name, timestamp_label_from_stem,
        upsert_recording_note, write_recording_metadata, RecordingImportantEventMetadata,
        RecordingMetadata, RecordingMetadataSnapshot,
    };
    use std::path::Path;
    use std::time::{SystemTime, UNIX_EPOCH};
