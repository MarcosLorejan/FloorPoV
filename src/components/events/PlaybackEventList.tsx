      ...
      <div className="min-h-0 flex-1 overflow-y-auto [scrollbar-gutter:stable]">
        {!videoSrc && !isRecording ? (
          <p className="px-3 py-4 text-xs text-neutral-500">
            Load a recording to see deaths, interrupts, dispels, crowd control, bloodlust, combat
            res, and markers.
          </p>
        ) : !hasTimelineEvents ? (
          <p className="px-3 py-4 text-xs text-neutral-500">
            No deaths, interrupts, dispels, crowd control, bloodlust, combat res, or markers in this
            recording.
          </p>
        ) : listEvents.length === 0 ? (
